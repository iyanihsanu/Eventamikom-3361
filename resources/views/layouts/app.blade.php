...
<body class="bg-slate-50 text-slate-900">
    ...
    <nav
        ...
        <a href="/" class="flex items-center gap-2 cursor-pointer hover:opacity-80 transition">
    ...
    <a href="/jelajahi" class="text-indigo-600">Jelajahi</a>
    ...
    <li><a href="/jelajahi" class="hover:text-white transition">Semua Event</a></li>
